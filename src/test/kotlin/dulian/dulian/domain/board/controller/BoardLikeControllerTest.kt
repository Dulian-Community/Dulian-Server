...
class BoardLikeControllerTest(
    ...
    describe("게시물 좋아요 API") {
        ...
        context("정상적인 요청인 경우") {
            ...
            it("게시물 좋아요 성공") {
                mockMvc.makeDocument("게시물 좋아요 성공", "게시물", "게시물 좋아요 API") {
                    requestLine(HttpMethod.POST, "/api/v1/board/like/{boardId}") {
                        pathVariable(1L)
                    }
                    pathParameters {
                        field("boardId", "게시물 번호")
                    }
                }
            }
        }
        ...
        context("게시물 정보가 존재하지 않는 경우") {
            ...
            it("게시물 좋아요 실패") {
                mockMvc.makeDocument("게시물 좋아요 실패", "게시물", "게시물 좋아요 API") {
                    requestLine(HttpMethod.POST, "/api/v1/board/like/{boardId}") {
                        pathVariable(1L)
                    }
